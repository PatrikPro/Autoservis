...
export default async function Hero() {
  ...
  return (
    <section className="relative overflow-hidden bg-industrial-stripes">
        ...
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 bg-primary text-white font-bold text-base px-8 py-4 rounded-lg hover:bg-primary-hover transition-colors"
            >
              {site.hero.ctaLabel}
            ...
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 bg-surface border border-border text-foreground font-bold text-base px-8 py-4 rounded-lg hover:border-primary/50 transition-colors"
            >
